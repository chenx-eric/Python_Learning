...
if i <= 10:
    ...
    r = 10*0.1 + 20*0.075 + (i - 20)*0.05
elif i < 60:
    r = 10*0.1 + 20*0.075 + 20*0.05 + (i - 40)*0.03
elif i < 100:
    r = 10*0.1 + 20*0.075 + 20*0.05 + 20*0.03 + (i - 60)*0.015
elif i >= 100:
    r = 10*0.1 + 20*0.075 + 20*0.05 + 20*0.03 + 40*0.015 + (i - 100)*0.01
